...
export const AddTaskBtn = () => {
    return (
        <>
            <div className='border-2 border-purple-500/50 flex gap-2 py-4 px-6 rounded-xl cursor-pointer fixed bottom-8 right-4 bg-[#7c6ef0] hover:bg-[#6a5cd8] hover:border-purple-400 active:scale-95 transition-all duration-150 items-center shadow-lg shadow-purple-900/40 z-1'>
